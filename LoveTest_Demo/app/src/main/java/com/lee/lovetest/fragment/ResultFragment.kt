package com.lee.lovetest.fragment
...
class ResultFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        option = arguments?.getInt("index")?:-1 // 전체가 null이면 -1 반환
    ...
    fun setResult(option: Int){
        when(option){
            ...
            3 -> {
                tv_main.text="You should take if easy."
                tv_sub.text="You can do crazy things no matter what it takes."
            }
            4 -> {
                tv_main.text="You are pretty nature."
